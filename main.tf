...
output "s3_bucket_name" {
  ...
  value       = aws_s3_bucket.portfolio_bucket.bucket # <-- Use the correct local name
}

output "cloudfront_distribution_id" {
  description = "The ID of the CloudFront distribution."
  value       = aws_cloudfront_distribution.portfolio_cdn.id # <-- Use the correct local name
}